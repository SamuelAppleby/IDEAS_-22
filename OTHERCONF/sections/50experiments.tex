...
%%<<<<<<< HEAD
	...
	\caption{KnoBAB vs SQLMiner Performance for 25  clauses with frequent activity labels with Support and Trace Information. OOM indicates Out of Secondary Memory (followed by time taken for exception to occur).}\label{fig:vsSQL}
%=======
...
%>>>>>>> afbd0a59ff585065401fffc3aefe36a3ae7a9b7f
\end{figure}
