...
\copyrightyear{2022}
\acmYear{2022}
\setcopyright{acmcopyright}\acmConference[IDEAS'22]{International Database Engineered Applications Symposium}{August 22--24, 2022}{Budapest, Hungary}
\acmBooktitle{International Database Engineered Applications Symposium (IDEAS'22), August 22--24, 2022, Budapest, Hungary}
\acmPrice{15.00}
\acmDOI{10.1145/3548785.3548786}
\acmISBN{978-1-4503-9709-4/22/08}
...
\input{sections/10introduction}
\input{sections/20related}
\input{sections/20a_declare}
%\input{sections/21temporallogicoperators}
\input{sections/22conformance}
\input{sections/30declare_definition}
\input{sections/40physical_model}
\input{sections/41data_loading}
\input{sections/42query_compiler}
\input{sections/43storage_manager}
\input{sections/44execution_engine}
\input{sections/45operator_semantics}
\input{sections/50experiments}
\input{sections/60conclusions}
